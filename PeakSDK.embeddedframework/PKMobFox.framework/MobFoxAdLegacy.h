...
@class MobFoxAdLegacy;

@protocol MobFoxAdLegacyDelegate <NSObject>

@optional

- (void)MobFoxAdDidLoad:(MobFoxAdLegacy *)banner;
...
@interface MobFoxAdLegacy : UIView <UIWebViewDelegate, MobFoxCustomEventDelegate, UIGestureRecognizerDelegate, MFExceptionHandlerDelegate>


@property (nonatomic, weak) id <MobFoxAdLegacyDelegate> delegate;
